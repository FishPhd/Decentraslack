					...
					<main>
						<div className="py-6">
							...
							<div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
								...
								{/* <div className="min-w-0 sm:flex flex-1">
...
<p>{message.message}</p>
												<p>{message.data.explorer_url}</p>
												<p>{message.data.reference}</p>
								...
								<div className="hidden pt-3 lg:col-span-2 lg:block">
										...
										<div className="pb-2">
											{messages.map((message, index) => (
												<a
													...
													className="group w-full flex-col-reverse"
												>
													<div
														key={index}
									...
									<div className="flex items-center justify-between w-full p-3 border-t border-gray-300">
										...
										>
											<PaperAirplaneIcon
												className="-ml-0.5 -rotate-90 mr-2 h-4 w-4"
												aria-hidden="true"
											/>
											Send
										</button>
